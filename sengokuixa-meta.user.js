...
skillTable: {
	...
	"鬼石曼子":		["鉄砲隊剛撃",	"忠魂座禅陣",	"釣り野伏 鬼",	"釣り野伏 真",	""],
	...
	"詭謀の宴":		["城崩 奈落",	"砲陣の極み",	"貴煌豊国",		"捨て奸",		"魔王三段撃"],
	"雷切":			["槍隊剛撃",	"砲陣の極み",	"洗礼の旗印",	"轟音 無鹿",	""],
	...
	"夜叉の構え":	["弓隊守護",	"槍隊挟撃",		"迅速行軍",		"夜叉の構え",	"鉄砲隊奇襲"],
	"相伴衆":		["龍哭の酒",	"剣術 攻乃型",	"矢雨備え",		"足軽軍法",		"弓隊守護"],
	"槍衾":			["槍衾",		"槍隊剛撃",		"槍隊円陣",		"義兵進軍",		"槍陣の極み"],
	"千樹挟撃陣":	["鉄砲隊円陣",	"車懸り",		"疾風迅雷",		"火竜の術",		"騎馬隊円陣"],
	"矢雨備え":		["矢雨備え",	"弓隊剛撃",		"弓隊円陣",		"三段撃 神速",	"弓陣の極み"],
	"藤巴葵陣":		["鉄壁の備え",	"三段撃ち",		"弾幕防壁陣",	"剛勇無双",		"八咫烏"],
	...
	"三つ鱗巴陣":	["鉄砲隊円陣",	"地黄八幡",		"三鱗竜騎兵",	"総構え",		"獅子の陣"],
	...
	"慧眼機略":		["城崩 奈落",	"馬陣の極み",	"砲撃 羅刹",	"騎神烈破",		""],
	"薩摩軍法":		["鉄砲隊剛撃",	"虎砲英主",		"忠魂座禅陣",	"繰抜十字紋",	"釣り野伏 真"],
	"英傑の師":		["矢雨備え",	"八咫烏",		"八龍堅陣",		"青海の騎将",	"覇道弓赤鳥"],
	"慧眼の用兵":	["砲陣の極み",	"騎神烈破",		"猛虎吼陣",		"天元の用兵",	""],
	"燕返し":		["槍陣の極み",	"騎突 金剛",	"弓撃 夜叉",	"柳生新陰流",	"剣聖"],
	"弓妖陣":		["鉄壁の備え",	"車懸り 白狐",	"八咫烏",		"背水之陣",		"神速"],
	"捨て奸":		["",			"",				"",				"捨て奸",		""],
	"君臣豊楽":		["砲陣の極み",	"弾幕防壁陣",	"釣り野伏 鬼",	"捨て奸",		"独眼竜"],
	"背水之陣":		["",			"",				"",				"背水之陣",		""],
	"戦國下克上":	["鉄壁の備え",	"組撃ち",		"車懸り 白狐",	"背水之陣",		""],
	...
	"車懸り":		["",			"",				"",				"車懸り 白狐",	""],
	"黒田のお年玉":	["鬼謀 国砕",	"神謀鬼略",		"天元の用兵",	"天衣無縫陣",	""],
	"武辺者見参":	["刹那の猛勇",	"騎突 金剛",	"砲陣の極み",	"車懸り",		"剛勇無双"],
	"摩利支天":		["鬼刺",		"弾幕防壁陣",	"剛勇無双",		"君臣豊楽",		"天元の用兵"],
	"流浪の勇将":	["三段撃 神速",	"疾風怒濤",		"鉄甲水軍",		"",				""],
	...
	"覇王征軍":		["",			"",				"",				"",				""],
	"玄武の陣":		["船穿応射",	"龍哭の酒",		"荒切武者",		"玄武の陣",		"騎馬隊守護"],
	"鉄壁の備え":	["鉄壁の備え",	"刹那の猛勇",	"真田丸",		"城崩し",		"組撃ち"],
	"泰平の焦れ":	["矢雨備え",	"三河堅陣",		"鉄壁の備え",	"桜花乱舞",		"君臣豊楽"],
	"才知徳行":		["鉄壁の備え",	"火竜の術",		"槍陣 弧月",	"才知徳行",		"鬼謀 国砕"],
	...
	"虚：微塵流":	["迅速行軍",	"宝蔵院流",		"新陰流",		"虚：微塵流",	"剣豪将軍"],
	...
	"槍撃日本号":	["槍撃 修羅",	"槍陣の極み",	"天槍の神技",	"甲駿の誓い",	"剣聖"],
	...
	"紫電一閃":		["四風賢鳳",	"荒切武者",		"龍哭の酒",		"紫電一閃",		"鉄砲隊布陣"],
	"戦国大返し":	["兵器運用術",	"迅速行軍",		"電光石火",		"神行法 千里",	""],
	"綱手の嘆き":	["騎馬隊円陣",	"電光石火",		"三河堅陣",		"疾風迅雷",		"疾風怒濤"],
	...
	"傾奇踊り":		["車懸り",		"馬陣の極み",	"疾風迅雷",		"組撃ち",		""],
	"天道格知":		["謀計奇策",	"神将",			"背水之陣",		"",				""],
	"攻城の妙技":	["",			"",				"",				"攻城の妙技",	""],
	"御用商人":		["砲撃 羅刹",	"砲陣の極み",	"車懸り",		"封技閃影",		"外法鳶陰"],
	"外法鳶陰":		["槍隊剛撃",	"車懸り",		"砲撃 羅刹",	"車懸り 白狐",	"神速"],
	"天下の義賊":	["城崩 奈落",	"砲陣の極み",	"砲撃 羅刹",	"疾風怒濤",		"独眼竜"],
	"武人の浄財":	["車懸り",		"槍陣の極み",	"神速",			"攻城の妙技",	""],
	"真言念破":		["驍将奇略",	"獅子の陣",		"神速",			"攻城の妙技",	"疾風怒濤"],
	"三姉妹の絆":	["弓陣 下り藤",	"速：桜花乱舞",	"砲陣 菖蒲",	"鬼刺",			""],
	"剣の礎":		["當理實手術",	"二天一流",		"燕返し",		"剣聖",			""],
	"一期一会":		["車懸り 白狐",	"疾風怒濤",		"剛勇無双",		"神速",			"神算鬼謀"],
	"天の福音":		["矢雨備え",	"天賦の神算",	"疾風怒濤",		"義兵進軍",		"神速"],
	"花魁心操術":	["真田丸",		"颯空術",		"戦陣 千鳥",	"雲散霧消",		""],
	"神童覚醒":		["砲陣の極み",	"砲撃 羅刹",	"疾風怒濤",		"鬼謀 国砕",	"八咫烏"],
	"西洋算術":		["神速",		"背水之陣",		"覇道 不如帰",	"天の福音",		""],
	"20140313":		["",			"",				"",				"",				""],
	"美麗なる返礼":	["独眼竜式目",	"旋風轟撃",		"八咫の構え",	"鳳凰炎舞",		""],
	"20140404":		["",			"",				"",				"",				""],
	"日輪の進軍":	["車懸り",		"砲陣の極み",	"砲撃 羅刹",	"疾風怒濤",		"殺生関白"],
	"日輪の礎":		["釣瓶撃ち",	"剛勇無双",		"組撃ち",		"疾風怒濤",		""],
	"冥界の花嫁":	["弓陣 下り藤",	"鬼神轟雷",		"君臣豊楽",		"魔王三段撃",	""],
	"加茂の閨閥":	["火竜の術",	"土壁の術",		"疾風迅雷",		"城崩 奈落",	"華玉神恵"],
	"一刀流":		["新陰流",		"剣豪将軍",		"柳生新陰流",	"新陰流逆風",	""],
	"偽りの饗応":	["国貫き",		"兵器布陣",		"偽りの饗応",	"乗り崩し",		"謀殺"],
	"退き佐久間":	["龍哭の酒",	"弓隊守備",		"火竜の術",		"槍隊守護",		"矢雨備え"],
	"馬廻御奉行":	["騎馬隊堅陣",	"馬廻御奉行",	"船穿応射",		"剣術 攻乃型",	"弓隊挟撃"],
	"武芸の饗宴":	["宝蔵院流",	"新陰流",		"柳生新陰流",	"剣豪将軍",		""],
	"20140428":		["",			"",				"",				"",				""],
	"大願幽夢":		["虎牙猛撃",	"弓馬構え",		"一領具足",		"槍陣の極み",	""],
	"焔 六冥銭":	["武運長久",	"戦陣 千鳥",	"死兵六道契",	"謀 表裏比興",	"日本一の兵"],
	"戦陣 真田丸":	["真田丸",		"武運長久",		"戦陣 千鳥",	"日本一の兵",	""],
	"真田丸 雁金":	["真田丸",		"槍馬鱗撃",		"真田丸 雁金",	"武運長久",		""],
	"夜討ノ大将":	["槍隊剛撃",	"弾幕防壁陣",	"七槍の極",		"槍砲方陣",		""],
	"亀甲車":		["防壁砕き",	"弓隊挟撃",		"鉄砲隊奇襲",	"亀甲車",		"国貫き"],
	"橙武者":		["鉄砲隊布陣",	"槍隊進撃",		"騎馬隊布陣",	"橙武者",		"弓隊進撃"],
	"天槍の舞":		["背水之陣",	"傾奇御免",		"八咫烏",		"攻城の妙技",	""]
},
